...
extern FUNC(Std_ReturnType, RTE_CODE) Rte_Write_PP_MirrorHeaterCommand_SendCommand( VAR(AUTOSAR_uint8, AUTOMATIC) command );
#define Rte_Write_SendCommand               Rte_Write_PP_MirrorHeaterCommand_SendCommand
